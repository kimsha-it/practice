...
// 새로운 배열을 출력한다
let new3 = numbers3.filter((element) => {
  if (element % 2 === 0) {
    return true;
  } else {
    return false;
...
// 새로운 배열을 출력한다
let new4 = people1.filter((element) => {
  if (element.age >= 20) {
    return true;
  } else {
    return false;
...
// 찾은 객체를 출력한다
let new5 = people2.filter((element) => {
  if (element.id === 2) {
    return true;
  } else {
    return false;
...
// 변환한 새로운 배열을 출력한다
let new6 = products.filter((element) => {
...
// 변환한 새로운 배열을 출력한다
let new8 = students.filter((element) => {
  if (element.score >= 70) {
    return true;
  } else {
    return false;
